...
cl /c /Fo:linear-collections\c_version\search_l1.obj /W4 /analyze /Zi /MD linear-collections\c_version\search_l1.c
if errorlevel 1 exit /b 1
link linear-collections\c_version\search_l1.obj /OUT:linear-collections\c_version\search_l1.exe /DEBUG
if errorlevel 1 exit /b 1

cl /c /Fo:linear-collections\cpp_version\search_l1.obj /W4 /analyze /Zi /MD /EHsc /std:c++latest linear-collections\cpp_version\search_l1.cpp
if errorlevel 1 exit /b 1
link linear-collections\cpp_version\search_l1.obj /OUT:linear-collections\cpp_version\search_l1.exe /DEBUG
if errorlevel 1 exit /b 1

cl /c /Fo:linear-collections\c_version\sort_l2.obj /W4 /analyze /Zi /MD linear-collections\c_version\sort_l2.c
if errorlevel 1 exit /b 1
link linear-collections\c_version\sort_l2.obj /OUT:linear-collections\c_version\sort_l2.exe /DEBUG
if errorlevel 1 exit /b 1

cl /c /Fo:linear-collections\cpp_version\sort_l2.obj /W4 /analyze /Zi /MD /EHsc /std:c++latest linear-collections\cpp_version\sort_l2.cpp
if errorlevel 1 exit /b 1
link linear-collections\cpp_version\sort_l2.obj /OUT:linear-collections\cpp_version\sort_l2.exe /DEBUG
if errorlevel 1 exit /b 1

cl /c /Fo:linear-collections\c_version\search_l3.obj /W4 /analyze /Zi /MD linear-collections\c_version\search_l3.c
if errorlevel 1 exit /b 1
link linear-collections\c_version\search_l3.obj /OUT:linear-collections\c_version\search_l3.exe /DEBUG
if errorlevel 1 exit /b 1

cl /c /Fo:linear-collections\cpp_version\search_l3.obj /W4 /analyze /Zi /MD /EHsc /std:c++latest linear-collections\cpp_version\search_l3.cpp
if errorlevel 1 exit /b 1
link linear-collections\cpp_version\search_l3.obj /OUT:linear-collections\cpp_version\search_l3.exe /DEBUG
if errorlevel 1 exit /b 1

cl /c /Fo:linear-collections\c_version\sort_l4.obj /W4 /analyze /Zi /MD linear-collections\c_version\sort_l4.c
if errorlevel 1 exit /b 1
link linear-collections\c_version\sort_l4.obj /OUT:linear-collections\c_version\sort_l4.exe /DEBUG
if errorlevel 1 exit /b 1

cl /c /Fo:linear-collections\cpp_version\sort_l4.obj /W4 /analyze /Zi /MD /EHsc /std:c++latest linear-collections\cpp_version\sort_l4.cpp
if errorlevel 1 exit /b 1
link linear-collections\cpp_version\sort_l4.obj  /OUT:linear-collections\cpp_version\sort_l4.exe /DEBUG
if errorlevel 1 exit /b 1

cl /c /Fo:linear-collections\c_version\search_l5.obj /W4 /analyze /Zi /MD linear-collections\c_version\search_l5.c
if errorlevel 1 exit /b 1
link linear-collections\c_version\search_l5.obj /OUT:linear-collections\c_version\search_l5.exe /DEBUG
if errorlevel 1 exit /b 1

cl /c /Fo:linear-collections\cpp_version\search_l5.obj /W4 /analyze /Zi /MD /EHsc /std:c++latest linear-collections\cpp_version\search_l5.cpp
if errorlevel 1 exit /b 1
